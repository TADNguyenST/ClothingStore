<%-- 
    ...
    Created on : Jun 14, 2025, 4:06:48 AM
    Author     : Lenovo
--%>
    ...
    <body>
        <div class="forgot-container">
            ...
            <form action="ForgotPassword" method="post" id="forgotForm">
                <div class="form-group">
                    ...
                    <div class="email-input-container">
                        <input type="email" name="email" id="email" class="email-input" placeholder="Enter your email address" required />
            ...
            <div class="back-section">
                ...
                <a href="${pageContext.request.contextPath}/Login" class="back-link">Login here</a>
            </div>
        </div>

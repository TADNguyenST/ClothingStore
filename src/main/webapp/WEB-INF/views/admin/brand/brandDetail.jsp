...
<body>
    ...
    <c:set var="pageTitle" value="Brand Details" scope="request"/>
                                    ...
                                    <div class="detail-section">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="detail-value">${brand.brandId}</div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="detail-section">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="detail-value">${not empty brand.description ? brand.description : 'N/A'}</div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="detail-section">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="detail-value">${not empty brand.createdAt ? brand.createdAt : 'N/A'}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="text-end">
                                        <a href="${pageContext.request.contextPath}/BrandManager?action=edit&id=${brand.brandId}" class="btn btn-primary btn-sm me-1">
                                            <i class="bi bi-pencil-square me-1"></i>Edit
                                        </a>
                                        <a href="${pageContext.request.contextPath}/BrandManager?action=list" class="btn btn-secondary btn-sm">

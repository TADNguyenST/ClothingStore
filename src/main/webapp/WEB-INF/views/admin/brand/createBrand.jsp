...
<body>
    ...
    <div class="content-area">
        <h2 style="text-align: center;">Create New Brand</h2>
        <!-- Debug information -->
        ...
        <form action="${pageContext.request.contextPath}/BrandCreateAdmin" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
            <input type="hidden" name="action" value="create">
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="name" class="form-label">Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="name" name="name" required maxlength="100" placeholder="e.g., Nike" oninput="validateName(this)">
                    <div class="invalid-feedback" id="nameFeedback">Please enter a valid brand name (max 100 characters).</div>
                </div>
                <div class="col-md-6">
    ...
    <script>
        ...
        function validateName(input) {
            ...
            const url = `${window.location.origin}${pageContext.request.contextPath}/BrandCheckDuplicateAdmin?name=` + encodeURIComponent(name);
            fetch(url)

                ...
                <div class="detail-section">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="detail-value"><c:out value="${brand.brandId}" default="N/A" /></div>
                        </div>
                        <div class="col-md-6">
                            <div class="detail-label">Name</div>
                            <div class="detail-value"><c:out value="${brand.name}" default="N/A" /></div>
                        </div>
                    </div>
                </div>
                <div class="detail-section">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="detail-value"><c:out value="${brand.description}" default="N/A" /></div>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="detail-section">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="detail-value">
                                <c:choose>
                                    <c:when test="${not empty brand.createdAt}">

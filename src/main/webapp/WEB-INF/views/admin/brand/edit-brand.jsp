                        ...
                        <div class="box-body">
                            ...
                            <c:choose>
                                    ...
                                    <form action="${pageContext.request.contextPath}/BrandManager" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" value="${brand.name}" required maxlength="100" placeholder="e.g., Nike">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <c:if test="${not empty brand.logoUrl}">
                                                    <div class="mt-2">
                                                        ...
                                                        <img src="${brand.logoUrl}" alt="Brand Logo" class="img-thumbnail">
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <textarea class="form-control" id="description" name="description" rows="3" placeholder="e.g., Premium sportswear brand">${brand.description}</textarea>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="text-end">
                                            <button type="submit" id="submitButton" class="btn btn-primary"><i class="bi bi-save me-1"></i>Update</button>
                                ...
                                <c:otherwise>
                                    ...
                                    <div class="text-end">
                                        <a href="${pageContext.request.contextPath}/BrandManager?action=list" class="btn btn-secondary"><i class="bi bi-arrow-left me-1"></i>Back to List</a>
                                    </div>
                                </c:otherwise>
                            </c:choose>
                        </div>

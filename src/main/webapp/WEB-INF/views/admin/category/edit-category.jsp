...
<body>
                        ...
                        <div class="box-body">
                            ...
                            <c:choose>
                                    ...
                                    <form action="${pageContext.request.contextPath}/CategoryManager" method="post" onsubmit="return validateForm()">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="name" name="name" class="form-control" value="${category.name}" required maxlength="100" placeholder="e.g., Men's Shirts" oninput="validateName(this)">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <textarea id="description" name="description" class="form-control" rows="3" placeholder="e.g., Shirts for men in various styles">${category.description}</textarea>
                                            </div>
                                            <div class="col-md-6">
                                ...
                                <c:otherwise>
                                    ...
                                    <div class="text-end">
                                        <a href="${pageContext.request.contextPath}/CategoryManager?action=list" class="btn btn-secondary"><i class="bi bi-arrow-left me-1"></i>Back to List</a>
                                    </div>
                                </c:otherwise>
                            </c:choose>
                        </div>
    ...
    <script>
        ...
        function validateName(input) {
            ...
            const url = `${window.location.origin}${pageContext.request.contextPath}/CategoryManager?action=checkDuplicate&name=` + encodeURIComponent(name) + `&categoryId=` + encodeURIComponent(categoryId);
            fetch(url)

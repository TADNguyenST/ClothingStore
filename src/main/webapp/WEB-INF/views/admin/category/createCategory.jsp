...
<body>
    ...
    <div class="content-area">
        ...
        <form action="${pageContext.request.contextPath}/CategoryCreateAdmin" method="post" onsubmit="return validateForm()">
                    ...
                    <select id="parentCategoryId" name="parentCategoryId" class="form-select" onchange="validateName(document.getElementById('name'))">
                        ...
                        <c:forEach var="category" items="${categories}">
                            <c:if test="${empty category.parentCategoryId}">
                                <option value="${category.categoryId}"><c:out value="${category.name}" default="N/A" /></option>
                            </c:if>
                        </c:forEach>
                    </select>
                </div>

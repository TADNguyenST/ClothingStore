...
public class StaffManagementController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        // Bắt đầu xử lý lấy danh sách nhân viên
        StaffDAO dao = new StaffDAO();
        List<StaffDAO.StaffInfo> staffList;

        String keyword = request.getParameter("keyword");
        if (keyword != null && !keyword.trim().isEmpty()) {
            staffList = dao.searchStaffByKeyword(keyword);
        } else {
        ...
        request.getRequestDispatcher("/WEB-INF/views/admin/mangestaff/staff-list.jsp").forward(request, response);
    } 

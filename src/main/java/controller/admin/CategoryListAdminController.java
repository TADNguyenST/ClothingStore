...
@WebServlet(name = "CategoryListAdminController", urlPatterns = {"/CategoryListAdmin"})
public class CategoryListAdminController extends HttpServlet {
    ...
    public String getServletInfo() {
        return "Servlet for listing all categories";
    }
}